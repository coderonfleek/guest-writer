...
On the **Security Rules** section of your database creation modal, select **Start in test mode** to enable `read` and `write` access to your database (ensure to setup security rules in production).
